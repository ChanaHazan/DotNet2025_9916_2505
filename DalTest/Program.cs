...
namespace DalTest
{
    internal class Program
    {
        ...
        {
            int select = PrintSubMenu("Prudact");
            switch (select)
            {
                case 1:
                    AddProduct();
        ...
        private static Customer AskCustomer(int id = 0)
        {
            ...
            Console.WriteLine("enter customer addres");
        ...
        private static void AddCustomer()
        {
            ...
            Console.WriteLine("created customer seccesful");
        }
        ...
        {
            int choice;
            Console.WriteLine($"{item} menu: create-1 ,delate-2 ,update-3 ,read-4 ,read all-5 ,exit - any key");
            int.TryParse(Console.ReadLine(), out choice);
            return choice;
        }
